...
(cd "$here/artifacts" && zip -FS Memberra-Jellyfin-1.3.0.zip Memberra/Memberra.Jellyfin.dll)
sha256sum "$here/artifacts/Memberra-Jellyfin-1.3.0.zip" > "$here/artifacts/Memberra-Jellyfin-1.3.0.zip.sha256"
