...
(cd "$here/artifacts" && zip -FS Memberra-Jellyfin-1.5.1.zip Memberra/Memberra.Jellyfin.dll)
sha256sum "$here/artifacts/Memberra-Jellyfin-1.5.1.zip" > "$here/artifacts/Memberra-Jellyfin-1.5.1.zip.sha256"
